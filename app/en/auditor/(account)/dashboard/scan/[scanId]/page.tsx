...
export default async function EnAuditorDashboardScanPage({
  params,
}: {
  ...
  redirect(`/en/auditor?scanId=${encodeURIComponent(scanId)}&token=${encodeURIComponent(scan.scan_access_token)}`)
}
