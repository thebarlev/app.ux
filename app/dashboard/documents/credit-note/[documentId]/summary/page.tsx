...
import CreditNoteSummaryClient from "./CreditNoteSummaryClient";

export default async function CreditNoteSummaryPage({
  params,
}: {
  ...
  if (document.document_type !== "credit_note") {
    return (
      <div className="ui-container pt-10">
        <div className="ui-alert-danger">
          <div className="font-bold">שגיאה</div>
          <div className="mt-2">תצוגת סיכום נתמכת כרגע לחשבוניות זיכוי בלבד</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <CreditNoteSummaryClient
      creditNote={document as any}
