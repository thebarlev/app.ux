 ...
 *
 * Renders payment-type-specific input fields for the tax invoice form.
    ...
    return (
      <PaymentGrid gridRef={gridRef}>
        ...
        <div className="w-full min-w-0">
          ...
          <Select value={payment.cardType ?? ""} onValueChange={(v) => onUpdate({ cardType: v })}>
        ...
        <div className="w-full min-w-0">
          ...
          <Select value={payment.cardDealType ?? "regular"} onValueChange={(v) => onUpdate({ cardDealType: v })}>
