...
export default function ReceiptPreviewModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="w-[95vw] max-w-[1200px] h-[92vh] bg-modal rounded-[20px] shadow-xl relative text-modal-fg overflow-hidden flex flex-col"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="p-4 sm:p-6 flex flex-col flex-1 min-h-0">
          ...
          <div className="relative bg-white rounded-lg overflow-hidden mx-auto w-[92vw] max-w-[1100px] flex-1 min-h-0">
            {isLoading && (
