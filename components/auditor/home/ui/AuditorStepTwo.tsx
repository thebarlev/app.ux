...
/**
 * The five seconds between the domain and the lead form.
 *
 * It used to carry the score and a "sign up and pay" link. Both moved behind
 * AuditorLeadGate: the score is what the form is asking to be traded for, and
 * showing it here gave it away — while the pay CTA now contradicts the flow and
 * was only reachable for as long as the animation runs.
 */
export function AuditorStepTwo(props: Props) {
  const { locale, status, step2IsWorking } = props
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-6 text-center">
      <Image src="/brand/black.svg" alt="Uxellent" width={140} height={48} priority={false} />
