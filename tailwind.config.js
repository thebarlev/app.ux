    ...
    extend: {
      ...
      colors: {
        ...
        dropdown: {
          ...
          itemSelected: "var(--dropdown-item-selected)",
      ...
      fontSize: {
        dropdown: ["var(--dropdown-text-size)", { lineHeight: "var(--dropdown-line-height)" }],
      },

      boxShadow: {
        ui: "0 1px 3px 0 rgba(0, 0, 0, 0.08)",
        "ui-md": "0 0px 6px -1px rgba(0, 0, 0, 0.8)",
        "ui-lg": "0 0px 15px 4px rgba(0, 0, 0, 0.07)",
        dropdown: "0 12px 30px var(--dropdown-shadow)",
      },
