-- ====================================================
-- 085 - EN flow: auditor charge -> tax_invoice (no VAT)
-- ====================================================
-- Purpose:
-- - Extend issue_auditor_charge_invoice_receipt_service with optional p_is_en
-- - When p_is_en = true (EN flow): issue tax_invoice with vat_rate=0 (חשבונית מס ללא מע״מ)
-- - When p_is_en = false (Hebrew flow): keep current behavior (invoice_receipt with vat_rate=18)
-- Notes:
-- - Hebrew / Israel flow unchanged
-- - EN detection is done by caller (process-indicator-event) via success_url
-- ====================================================
