-- ====================================================
-- 097 - RPC: insert into auditor_invoice_documents on issue
-- ====================================================
-- Requires: 096 (auditor_invoice_documents table)
-- ====================================================
...
begin
  ...
  -- Line items (same as 094)
  select exists (select 1 from information_schema.columns where table_schema='public' and table_name='document_line_items' and column_name='item_date') into v_has_item_date;
  select exists (select 1 from information_schema.columns where table_schema='public' and table_name='document_line_items' and column_name='currency') into v_has_currency_li;
  select exists (select 1 from information_schema.columns where table_schema='public' and table_name='document_line_items' and column_name='payment_metadata') into v_has_payment_metadata;
  ...
  -- Link issuer+buyer for RLS (issuer sees in dashboard)
