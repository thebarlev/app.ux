-- ====================================================
-- 101 - Fix: INSERT has more target columns (minimal columns only)
-- ====================================================
-- Use ONLY the 7 base columns for document_line_items.
-- Optional columns (item_date, currency, payment_metadata) get NULL/default.
-- ====================================================
...
begin
  ...
  -- Line item: MINIMAL 7 columns only (base schema from 006). Optional columns get default/NULL.
