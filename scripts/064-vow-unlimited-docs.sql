-- ====================================================
-- 064 - VOW billing company: unlimited documents (1,000,000)
-- ====================================================
-- Purpose:
-- - Company 4ae68334-15a0-4fa3-a9ba-fd77deccc95d (VOW) bypasses usage limit
-- - Effective limit = 1,000,000 for finalize guard and subscription status
-- ====================================================
...
begin
  ...
  -- Free hard cap (VOW company has v_limit=1000000, so effectively no cap)
