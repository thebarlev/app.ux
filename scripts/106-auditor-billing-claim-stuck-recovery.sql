-- ====================================================
-- 106 - Auditor billing: add stuck-event recovery (5 min)
-- ====================================================
-- Purpose: claim_pending also reclaims events stuck in 'processing'
-- for > 5 minutes (worker crashed / timeout).
-- ====================================================
  ...
  for r in
    ...
    where e.provider = p_provider
      ...
      and (
        ...
        or (e.status = 'processing' and e.processing_started_at < now() - interval '5 minutes')
      )
